...
class ArticlesFragment : BaseFragment<ArticlesViewModel>() {
    ...
    private val articlesAdapter=ArticlesAdapter{item->
        Log.e("ArticleFragment","click on article: ${item.id}")
        val action=ArticlesFragmentDirections.actionNavArticlesToPageArticle(item.id,item.author,item.authorAvatar,
